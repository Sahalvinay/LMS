...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-x-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0' >
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500' >
        ...
        <div className='dlex flex-col gap-1' >
          <p>Discount %</p>
        ...
        <div>
          ...
          {
            showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-opacity-50 bg-gray-50 ' >
