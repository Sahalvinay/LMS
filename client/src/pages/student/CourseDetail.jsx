...
const CourseDetail = () => {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-cyan-100/70' >
      <div className='absolute top-0 left-0 w-full -z-1'></div>
      {/* left */}
      ...
      {/* right */}
      <div className='max-w-3xs z-10 shadow-lg shadow-red-300 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]' >
          {
            playerData ? 
          ...
          <div className='p-5' >
            ...
            <div className='flex gap-3 items-center pt-2' >
              <p className='text-gray-800 md:text-4xl text-2xl font-semibold' >{currency}{((courseData.coursePrice || 0) - (courseData.courseDiscount || 0) * (courseData.coursePrice || 0) / 100).toFixed(2)}</p>
